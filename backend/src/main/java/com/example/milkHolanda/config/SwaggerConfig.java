package com.example.milkHolanda.config;
...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.example.milkHolanda.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "API Commerce",
                "Esta API foi construída para fins didáticos!",
                "Versão 1.0",
                "Sem termos",
                new Contact("Ramon Holanda", "", "ramonsilva.silva.rsrs@gmail.com"),
                "Uso Liberado!",
                "",
